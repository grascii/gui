...
class Application(tk.Frame):
    ...
    def create_search_bar(self):
        ...
        frm_search.grid(row=0, column=1, sticky="nw", padx=DEFAULT_PADDING, pady=DEFAULT_PADDING)
    ...
    def create_settings_frame(self):
        ...
        frm_settings.grid(row=1, column=0, padx=DEFAULT_PADDING, pady=DEFAULT_PADDING, sticky="n")
